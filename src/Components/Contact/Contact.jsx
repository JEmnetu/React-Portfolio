...
const Contact = (props) => {
    ...
    <div className="container-fluid" id="target">
           ...
           {/* <div className="col-xs-1 offset-2"> <a href={props.github} target="_blank" rel="noopener noreferrer"> <i class="fab fa-github fa-4x"></i></a></div>
               ...
               <div className="col-xs-5 jumbotron mx-auto" id="main-text">

                   <h1 id="mainHeader">Let's Connect!</h1>
                   <ul>
                        <li><a href={props.github} rel="noopener noreferrer"><i class="fab fa-github fa-3x"></i></a></li>
                        <li><a href={props.linkedin} rel="noopener noreferrer"><i class="fab fa-linkedin fa-3x"></i></a></li>
